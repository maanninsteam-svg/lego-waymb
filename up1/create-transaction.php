...
$client_id = $_wcfg['client_id'] ?? 'boy_7cb5273e';
$client_secret = $_wcfg['secret'] ?? '6813adc6-d012-4088-9f9d-18056ccf0a98';
$account_email = $_wcfg['email'] ?? 'boysurfista047@proton.me';
...
if ($amount <= 0) {
    $amount = central_price('front', 12.97);
}
